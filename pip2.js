...
<head>
  ...
  <style>
    :root {
      ...
      --secondary-color: oklch(0.4 0.01 240);

      --success-color: oklch(0.65 0.15 130);
      --success-bg: oklch(0.2 0.05 130);
      --success-text: oklch(0.85 0.05 130);

      --warning-color: oklch(0.75 0.18 75);
      --warning-bg: oklch(0.25 0.06 75);
      --warning-text: oklch(0.80 0.06 75);
      
      --error-color: oklch(0.6 0.2 25);
      --error-bg: oklch(0.2 0.07 25);
      --error-text: oklch(0.85 0.07 25);
    ...
    .result-success h3 { color: var(--success-color); }
    .result-error h3 { color: var(--error-color); }
    .result-warning h3 { color: var(--warning-color); }
...
<body>
  <div class="container">
    <header class="header">
      <h1 class="main-title">proxyIP <span class="accent-orange-text">Checker</span></h1>
    </header>
    ...
    <div class="card">
      <div class="form-section">
        ...
        <div class="input-wrapper">
          <input type="text" id="proxyip" class="form-input" placeholder="1.2.3.4:443 or domain.com" autocomplete="off">
        </div>
        
        <label for="proxyipRange" class="form-label">Enter IP Range (1.2.3.0/24 or 1.2.3.1-255):</label>
        <div class="input-wrapper">
          <input type="text" id="proxyipRange" class="form-input" placeholder="1.2.3.0/24 or 1.2.3.1-255" autocomplete="off">
        </div>
    ...
    <div class="api-docs">
       <h3 style="margin-bottom:10px; color: var(--text-primary);">API Documentation</h3>
    ...
    <footer class="footer">
      <p>© ${new Date().getFullYear()} <strong>proxyIP Checker</strong> | Developed by <a href="https://github.com/sahar-km" target="_blank">sahar-km</a></p>
    </footer>
  </div>
  ...
  <script>
    ...
    function updateRangeSuccessChart(successfulIPs) {
        ...
        const borderColor = getComputedStyle(document.documentElement).getPropertyValue('--border-color').trim() || '#3c3e45';
        const accentColor = getComputedStyle(document.documentElement).getPropertyValue('--accent-orange').trim() || '#F97316';
        const accentColorBg = accentColor + '99'; // Add alpha for background
    ...
    function formatIPInfo(ipInfo, isShort = false) {
      ...
      if(isShort) return \`<span style="color: var(--text-light);">(\${country} - \${as.substring(0,15)}...)</span>\`;
